  ...
  const gearCategories: GearCategory[] = [
    {
      ...
      items: [
        { 
          ...
          icon: <BsMotherboard className="text-myPink1 text-lg" />,
          image: "/img/gear/motherboard.webp"
        },
        { 
          name: "CPU",
          value: "Intel i5-13600K", 
          icon: <FaMicrochip className="text-myPink1 text-lg" />,
          image: "/img/gear/cpu.webp"
        },
        { 
          name: "GPU",
          value: "Sapphire RX 6650 XT 8GB", 
          icon: <BsGpuCard className="text-myPink1 text-lg" />,
        ...
        { 
          ...
          icon: <FaMemory className="text-myPink1 text-lg" />,
          image: "/img/gear/ram.webp"
        },
        { 
          name: "NVMe SSD", 
          value: "Kingston KC3000 2TB", 
          icon: <FaHdd className="text-myPink1 text-lg" />,
        ...
        { 
          ...
          icon: <FaPowerOff className="text-myPink1 text-lg" />,
          image: "/img/gear/psu.webp"
        },
        { 
          name: "Case", 
          value: "GIGABYTE C200", 
          icon: <PiDesktopTowerDuotone className="text-myPink1 text-lg" />,
          image: "/img/gear/case.webp"
        },
        { 
          name: "Cooler", 
          value: "Thermalright Aqua Elite 240", 
          icon: <FaFan className="text-myPink1 text-lg" />,
        ...
        { 
          ...
          value: "GNU/Linux", 
          icon: <FaLinux className="text-myPink1 text-lg" />,
          image: "/img/gear/linux.webp"
        },
        { 
          name: "Distribution", 
          value: "Arch Linux / Gentoo / NixOS", 
          icon: <DiLinux className="text-myPink1 text-lg" />,
          image: "/img/gear/distros.webp"
        },
        { 
          name: "Dynamic Window Manager", 
          value: "Hyprland", 
          icon: <BiSolidCog className="text-myPink1 text-lg" />,
    ...
    },
    {
      ...
      items: [
        { 
          ...
          icon: <FaLaptop className="text-myPink1 text-lg" />,
    ...
    },
    {
      ...
      items: [
        { 
          ...
          icon: <FaServer className="text-myPink1 text-lg" />,
    ...
    },
    {
      ...
      items: [
        { 
          ...
          icon: <HiMiniDevicePhoneMobile className="text-myPink1 text-lg" />,
  ...
  return (
    <div className="pt-24 px-4 max-w-5xl mx-auto">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-4xl font-bold text-center flex-grow">UmmIt Gears <DiLinux className="text-myPink1 text-4xl inline-block mb-2" /> :)</h1>
        <div className="flex items-center">
          <span className="mr-2 text-gray-300">Text</span>
          <input 
            type="checkbox" 
            ...
            onChange={toggleView}
          />
          <span className="ml-2 text-gray-300">Images</span>
        </div>
      </div>
