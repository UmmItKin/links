          ...
          <div className="max-w-md">
            <label className="swap swap-flip text-9xl pb-5">
              ...
              <div className="swap-on">
                <img width="150" height="150" src={userData.imagePaths.on} alt="On" />
              </div>
              <div className="swap-off">
                <img width="150" height="150" src={userData.imagePaths.off} alt="Off" />
              </div>
            </label>
            ...
            <div className="flex flex-wrap justify-center">
              <div className="px-1">
                <a className="btn btn-ghost btn-circle fill-stroke text-gray-500 hover:text-blue-500" href={userData.gitlab_url} target="_blank">
              ...
              <div className="px-1">
                <a className="btn btn-ghost btn-circle fill-stroke text-gray-500 hover:text-blue-500" href={userData.github_url} target="_blank">
                  <svg className="h-8 w-8" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <div className="px-1">
                <a className="btn btn-ghost btn-circle fill-stroke text-gray-500 hover:text-blue-500" href={"mailto:" + userData.mail_address}>
                  <svg className="h-8 w-8" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
